...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {        // Locate the RMI registry using received socket
            ...
            try {
                ...
                log.error("Could not lookup the exposed weather forecaster object in the registry. Status: {}", e.getMessage());
            }
        } catch (Exception e) {
            log.error("RMI client failed: {}", e.getMessage());
        }
    }
    ...
    private static VectorOperator getVectorMath(Registry registry) {
        ...
        try {
            ...
            log.error("Lookup failure: remote object '{}' NOT BOUND", rmiObjectName);
        }
        return vectorMath;
    }
